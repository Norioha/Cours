...
C_DEPS += \
./hal/mpu/mbed_mpu_v7m.d \
./hal/mpu/mbed_mpu_v8m.d 

OBJS += \
./hal/mpu/mbed_mpu_v7m.o \
./hal/mpu/mbed_mpu_v8m.o 


# Each subdirectory must supply rules for building sources it contributes
hal/mpu/%.o: ../hal/mpu/%.c hal/mpu/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-hal-2f-mpu

clean-hal-2f-mpu:
	-$(RM) ./hal/mpu/mbed_mpu_v7m.d ./hal/mpu/mbed_mpu_v7m.o ./hal/mpu/mbed_mpu_v8m.d ./hal/mpu/mbed_mpu_v8m.o

.PHONY: clean-hal-2f-mpu
